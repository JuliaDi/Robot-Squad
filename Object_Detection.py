# -*- coding: utf-8 -*-
"""
Created on Mon Apr 30 07:53:47 2018
...
# 
# #if contour count == 1 and no child it is an object
...
def get_angle(netPositionX, netPositionY):
    #Use this to stay away from errors
    angle1 = 0
...
#     #                    #result = np.array(re.split("\s+", cnt.replace('[','').replace(']','')), dtype=int)
#     #                    #i, j = list(cnt[0])
#     #                    # thresh[k,j] = 0
#     #                     cv2.drawContours(testingthresh, imgContours, cnt,(255,255,255),-1)
#     # =============================================================================
#                     continue
...
# # =============================================================================
#     img2, imgContours, hierarchy = cv2.findContours(testingthresh,cv2.RETR_TREE,cv2.CHAIN_APPROX_SIMPLE)
# =============================================================================
...
# =============================================================================
        ...
        while hierarchy[0][parent][0] > -1 or hierarchy[0][parent][2] > -1:
           # robotNumber = hierarchy[0][0]
            ...
            contourTotal = 1
            #objectArea = cv2.contourArea(imgContours[parent])
            ...
            while True:
                ...
                #Get the index location of the contour
                holdContourLoc = childorNext
               ...
               # cv2.drawContours(savedImageColor, imgContours, childorNext, (255,0,0), 3)
                ...
                if contourTotal > 1:
                    cv2.drawContours(savedImageColor, imgContours, hierarchy[0][childorNext][1], (255,0,0), 2)
                    cv2.drawContours(savedImageColor, imgContours, childorNext, (255,0,0), 2)
                    isRobot = True
            ...
            elif contourTotal == 1 and currentArea > 1000:
            ...
            print("contour number is ", contourTotal)
    ...
    cv2.imshow('testthresh', testingthresh)
